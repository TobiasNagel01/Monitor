                                ...
                                @forelse($users as $users)
                                    <tr>
                                        ...
                                        <td class="relative whitespace-nowrap p-4 text-right text-sm font-medium sm:pr-6 select-none">
                                            <x-interface.button :route="route('users.edit', $users)" type="btn-secondary" filled icon="o-pencil-square" />
                                            <x-interface.button :route="route('users.delete', $users)" type="btn-danger" filled confirm-destroy icon="o-trash" />
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
